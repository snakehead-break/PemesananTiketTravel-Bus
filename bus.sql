...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 08 Jan 2023 pada 14.02
...
--
-- Struktur dari tabel `tbl_admin_41518110070`
--
...
--
-- Dumping data untuk tabel `tbl_admin_41518110070`
--
...
('ADM0001', 'Fauzan', 'supervisor', '$2y$10$v25.H4XMgDztA2NmxeJQSeaRl2nKboXeRTo1BjPe37R0JG3rXraZG', 'assets/backend/img/default.png', 'owner@gmail.com', '1', 1, '1552819095'),
('ADM0002', 'khadafi', 'admin', '$2y$10$v25.H4XMgDztA2NmxeJQSeaRl2nKboXeRTo1BjPe37R0JG3rXraZG', 'assets/backend/img/default.png', 'adm@gmail.com', '2', 1, '1552276812');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tbl_bank_41518110070`
--
...
--
-- Dumping data untuk tabel `tbl_bank_41518110070`
--

INSERT INTO `tbl_bank_41518110070` (`kd_bank`, `nasabah_bank`, `nama_bank`, `nomrek_bank`, `photo_bank`) VALUES
('BNK0001', 'fauzan', 'BCA', '54902520644', 'assets/frontend/img/bank/bca-icon.jpg'),
('BNK0002', 'fauzan', 'MANDIRI', '6666666666', 'assets/frontend/img/bank/mandiri-icon.jpg'),
('BNK0003', 'fauzan', 'BRI', '7777777777', 'assets/frontend/img/bank/bri-icon.jpg'),
('BNK0004', 'fauzan', 'BNI', '8888888888', 'assets/frontend/img/bank/bni-icon.jpg');
...
--
-- Struktur dari tabel `tbl_jadwal_41518110070`
--
...
--
-- Dumping data untuk tabel `tbl_jadwal_41518110070`
--
...
--
-- Struktur dari tabel `tbl_konfirmasi_41518110070`
--
...
--
-- Dumping data untuk tabel `tbl_konfirmasi_41518110070`
--
...
('KF0002', 'ORD00003', 'fauzan', 'Mandiri', '26326628', '120000', '/assets/frontend/upload/payment/Screenshot_(2)1.png');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tbl_level_41518110070`
--
...
--
-- Dumping data untuk tabel `tbl_level_41518110070`
--
...
--
-- Struktur dari tabel `tbl_menu_41518110070`
--
...
--
-- Dumping data untuk tabel `tbl_menu_41518110070`
--
...
--
-- Struktur dari tabel `tbl_order_41518110070`
--
...
--
-- Dumping data untuk tabel `tbl_order_41518110070`
--
...
(35, 'ORD00003', 'TORD00003202301101', 'J0002', 'PL0009', 'BNK0002', 'TJ008', 'fauzan', 'Minggu, 08 Januari 2023, 19:56', '2023-01-10', 'fauzan', '89', '1', '992763282719', '01930989327', 'sukabirus', 'qksjqooo@gmail.com', '09-01-2023 19:56:52', 'assets/frontend/upload/qrcode/ORD00003.png', '2');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tbl_pelanggan_41518110070`
--
...
--
-- Dumping data untuk tabel `tbl_pelanggan_41518110070`
--
...
('PL0009', 'fauzan', '$2y$10$NWyzlITqGtIfQgqtgHPbTeSVFvN6wMGYG34lj2Ougn76jzB/36mOi', '', 'fauzan', 'sukabirus', 'qksjqooo@gmail.com', '01930989327', 'assets/frontend/img/default.png', 0, '1673182549');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tbl_tiket_41518110070`
--
...
--
-- Dumping data untuk tabel `tbl_tiket_41518110070`
--
...
('TORD00003202301101', 'ORD00003', 'fauzan', '1', '89 Tahun', 'TJ008', '120000', 'assets/backend/upload/etiket/ORD00003.pdf', '2', '2023-01-08', 'supervisor');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tbl_tujuan_41518110070`
--
...
--
-- Dumping data untuk tabel `tbl_tujuan_41518110070`
--
...
--
-- Indeks untuk tabel `tbl_admin_41518110070`
--
ALTER TABLE `tbl_admin_41518110070`
  ADD PRIMARY KEY (`kd_admin`);

--
-- Indeks untuk tabel `tbl_bank_41518110070`
--
...
--
-- Indeks untuk tabel `tbl_jadwal_41518110070`
--
...
--
-- Indeks untuk tabel `tbl_konfirmasi_41518110070`
--
...
--
-- Indeks untuk tabel `tbl_level_41518110070`
--
ALTER TABLE `tbl_level_41518110070`
  ADD PRIMARY KEY (`kd_level`);

--
-- Indeks untuk tabel `tbl_menu_41518110070`
--
ALTER TABLE `tbl_menu_41518110070`
  ADD PRIMARY KEY (`kd_menu`);

--
-- Indeks untuk tabel `tbl_order_41518110070`
--
...
--
-- Indeks untuk tabel `tbl_pelanggan_41518110070`
--
ALTER TABLE `tbl_pelanggan_41518110070`
  ADD PRIMARY KEY (`kd_pelanggan`);

--
-- Indeks untuk tabel `tbl_tiket_41518110070`
--
...
--
-- Indeks untuk tabel `tbl_tujuan_41518110070`
--
...
--
-- AUTO_INCREMENT untuk tabel `tbl_level_41518110070`
--
ALTER TABLE `tbl_level_41518110070`
  MODIFY `kd_level` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT untuk tabel `tbl_menu_41518110070`
--
ALTER TABLE `tbl_menu_41518110070`
  MODIFY `kd_menu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT untuk tabel `tbl_order_41518110070`
--
ALTER TABLE `tbl_order_41518110070`
